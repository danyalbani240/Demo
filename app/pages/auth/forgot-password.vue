<template>
  ...
  >
    ...
    <div aria-hidden="true" class="pointer-events-none absolute inset-0">
      <div class="absolute -top-32 -left-32 h-80 w-80 rounded-full bg-indigo-500/10 blur-3xl" />
      <div class="absolute -bottom-40 -right-40 h-96 w-96 rounded-full bg-fuchsia-500/10 blur-3xl" />
    ...
    <div class="relative z-10 flex min-h-[100dvh] items-center justify-center px-4 py-8">
      ...
      >
        ...
        <div class="mt-4 grid gap-3">
          ...
          <div class="mt-1 text-center text-xs text-gray-600 dark:text-zinc-300/80">
            کد را دریافت کردید؟
            <NuxtLink
...
async function submit() {
  ...
  try {
    ...
    errorMsg.value = String(e?.data?.message || e?.statusMessage || "ارسال کد ناموفق بود")
  } finally {
    loading.value = false
  }
}
